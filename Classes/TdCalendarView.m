...
-(void)drawTopBarWords{
	...
	CGPoint  location = CGPointMake(width/2 -2.5*titleFontSize, 88);
...
- (void) touchAtDate:(CGPoint) touchPoint{
    ...
    NSDictionary *dictionary1 = [NSDictionary dictionaryWithObject:time forKey:@"Date"];
    [[NSNotificationCenter defaultCenter]postNotificationName:@"changeView" object:nil userInfo:dictionary1];
 }
